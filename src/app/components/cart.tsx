...
export default function CartSidebar() {
    ...
    return (
        ...
        >
            ...
            <div className="overflow-y-auto scrollbar-hide px-4 py-4 pb-16 space-y-4" style={{ height: 'calc(100% - 160px)' }}>
                {cart.length === 0 ? (
                            ...
                            <div className="grid gap-2">
                                ...
                                <div className="flex items-center space-x-2">
                                    <button
                                        ...
                                        onClick={() => dispatch({ type: 'DECREASE_QUANTITY', payload: item.slug })}
